...
with col1:
    if 'Curricular_units_2nd_sem_approved' in features:
    ...
    if 'Curricular_units_1st_sem_approved' in features:
    ...
    if 'Curricular_units_2nd_sem_enrolled' in features:
    ...
    if 'Curricular_units_1st_sem_enrolled' in features:
...
# Encode fitur kategorik jika perlu
if 'Tuition_fees_up_to_date' in input_df.columns:
